...
Controller::Segment Controller::calculateNewHead(const Segment& currentHead) const
{
    Segment newHead;
...
void Controller::removeOldFood() const
{
...
void Controller::placeNewFood(const FoodInd& receivedFood) const
{
